...
type
  TMPendidikanFrm = class(TForm)
    ...
    cxGrid1DBTableView2PENDIDIKAN: TcxGridDBColumn;
...
var
  MPendidikanFrm: TMPendidikanFrm;
...
procedure TMPendidikanFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMPendidikanFrm.FormClose(Sender: TObject;
...
procedure TMPendidikanFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMPendidikanFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMPendidikanFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMPendidikanFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMPendidikanFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMPendidikanFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMPendidikanFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
