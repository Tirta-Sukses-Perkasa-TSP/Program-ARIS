object MSatuanFrm: TMSatuanFrm
  ...
  object Panel1: TPanel
    ...
    object cxDBTextEdit1: TcxDBTextEdit
      Left = 101
      Top = 91
      DataBinding.DataField = 'kode_satuan'
      DataBinding.DataSource = DataSource1
      ParentFont = False
      Properties.CharCase = ecUpperCase
      Style.Color = clInfoBk
    ...
    object cxDBTextEdit3: TcxDBTextEdit
      Left = 101
      Top = 123
      DataBinding.DataField = 'nama_satuan'
      DataBinding.DataSource = DataSource1
      ParentFont = False
      Properties.CharCase = ecUpperCase
      Style.Color = clInfoBk
  ...
  object Panel4: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView2: TcxGridDBTableView
        ...
        object cxGrid1DBTableView2kode_satuan: TcxGridDBColumn
          DataBinding.FieldName = 'kode_satuan'
          Width = 128
        end
        object cxGrid1DBTableView2nama_satuan: TcxGridDBColumn
          Caption = 'SATUAN'
  ...
  object DataSource1: TDataSource
    DataSet = _DataModuleMaster.Msatuan
    Left = 26
    Top = 376
  end
