...
uses
  ...
  dxSkinsCore, MemDS, DBAccess, Uni;

type
  TMList_DepoFrm = class(TForm)
    ...
    cxGrid1DBTableView2KODE_SAP: TcxGridDBColumn;
    cxGrid1DBTableView2KETERANGAN: TcxGridDBColumn;
    cxGrid1DBTableView2SUPPORTED_BRANCH: TcxGridDBColumn;
    cxGrid1DBTableView2SUPPORTED_KETERANGAN: TcxGridDBColumn;
    cxGrid1DBTableView2GROUPING: TcxGridDBColumn;
    cxGrid1DBTableView2KODE_SHIP_TO: TcxGridDBColumn;
    cxGrid1DBTableView2kode_Sap_2: TcxGridDBColumn;
    cxGrid1DBTableView2kode_sap_2_nama: TcxGridDBColumn;
    cxGrid1DBTableView2MAP_PLANT: TcxGridDBColumn;
    cxGrid1DBTableView2Nama_Origin: TcxGridDBColumn;
    cxGrid1DBTableView2SUPPLY_PLANT_KD: TcxGridDBColumn;
    cxGrid1DBTableView2visible: TcxGridDBColumn;
    cxGrid1DBTableView2Batch_CD: TcxGridDBColumn;
    cxGrid1DBTableView2Setting_Planning: TcxGridDBColumn;
    cxGrid1DBTableView2Branch_Origin: TcxGridDBColumn;
    UniQuery1: TUniQuery;
    cxGrid1DBTableView2alamat1: TcxGridDBColumn;
    cxGrid1DBTableView2alamat2: TcxGridDBColumn;
    cxGrid1DBTableView2alamat3: TcxGridDBColumn;
    cxGrid1DBTableView2telp1: TcxGridDBColumn;
    cxGrid1DBTableView2telp2: TcxGridDBColumn;
...
procedure TMList_DepoFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMList_DepoFrm.FormClose(Sender: TObject;
...
procedure TMList_DepoFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMList_DepoFrm.FormShow(Sender: TObject);
begin
  if _DataModule.Vadmin='1' then
  begin
    _DataModuleMaster.MPlant.readonly:=False;
  end
  else
  begin
     _DataModuleMaster.MPlant.ReadOnly:=True;
  end;
...
procedure TMList_DepoFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMList_DepoFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMList_DepoFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMList_DepoFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMList_DepoFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
