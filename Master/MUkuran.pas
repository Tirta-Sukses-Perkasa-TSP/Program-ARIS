...
type
  TMUkuran_Frm = class(TForm)
    ...
    cxGrid1DBTableView2UKURAN: TcxGridDBColumn;
    cxGrid1DBTableView2KETERANGAN: TcxGridDBColumn;
    cxGrid1DBTableView2JUMLAH_PCS: TcxGridDBColumn;
...
procedure TMUkuran_Frm.SetUpButtonOtorisasi;
begin
end;

procedure TMUkuran_Frm.FormClose(Sender: TObject;
...
procedure TMUkuran_Frm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMUkuran_Frm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMUkuran_Frm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMUkuran_Frm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMUkuran_Frm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMUkuran_Frm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMUkuran_Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
