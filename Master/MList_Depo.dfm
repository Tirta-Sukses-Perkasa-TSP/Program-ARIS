object MList_DepoFrm: TMList_DepoFrm
  Left = 153
  Top = 81
  BorderStyle = bsDialog
  BorderWidth = 1
  Caption = 'MList_DepoFrm'
  ClientHeight = 626
  ClientWidth = 1037
  Color = clWhite
  ...
  object Panel4: TPanel
    ...
    object cxGrid1: TcxGrid
      ...
      object cxGrid1DBTableView2: TcxGridDBTableView
        ...
        OptionsBehavior.IncSearch = True
        OptionsView.Navigator = True
        object cxGrid1DBTableView2BRANCH: TcxGridDBColumn
          DataBinding.FieldName = 'BRANCH'
          Width = 63
        end
        object cxGrid1DBTableView2KODE_SAP: TcxGridDBColumn
          DataBinding.FieldName = 'KODE_SAP'
          Width = 98
        end
        ...
        object cxGrid1DBTableView2SUPPORTED_BRANCH: TcxGridDBColumn
          DataBinding.FieldName = 'SUPPORTED_BRANCH'
        end
        object cxGrid1DBTableView2SUPPORTED_KETERANGAN: TcxGridDBColumn
          DataBinding.FieldName = 'SUPPORTED_KETERANGAN'
          Width = 170
        end
        object cxGrid1DBTableView2GROUPING: TcxGridDBColumn
          DataBinding.FieldName = 'GROUPING'
          Width = 64
        end
        object cxGrid1DBTableView2KODE_SHIP_TO: TcxGridDBColumn
          DataBinding.FieldName = 'KODE_SHIP_TO'
          Width = 88
        end
        object cxGrid1DBTableView2kode_Sap_2: TcxGridDBColumn
          DataBinding.FieldName = 'kode_Sap_2'
          Width = 67
        end
        object cxGrid1DBTableView2kode_sap_2_nama: TcxGridDBColumn
          DataBinding.FieldName = 'kode_sap_2_nama'
          Width = 97
        end
        object cxGrid1DBTableView2MAP_PLANT: TcxGridDBColumn
          DataBinding.FieldName = 'MAP_PLANT'
          Width = 78
        end
        object cxGrid1DBTableView2Nama_Origin: TcxGridDBColumn
          DataBinding.FieldName = 'Nama_Origin'
          Width = 94
        end
        object cxGrid1DBTableView2SUPPLY_PLANT_KD: TcxGridDBColumn
          DataBinding.FieldName = 'SUPPLY_PLANT_KD'
          Width = 75
        end
        object cxGrid1DBTableView2visible: TcxGridDBColumn
          DataBinding.FieldName = 'visible'
          Width = 56
        end
        object cxGrid1DBTableView2Batch_CD: TcxGridDBColumn
          DataBinding.FieldName = 'Batch_CD'
          Width = 72
        end
        object cxGrid1DBTableView2Setting_Planning: TcxGridDBColumn
          DataBinding.FieldName = 'Setting_Planning'
          Width = 86
        end
        object cxGrid1DBTableView2Branch_Origin: TcxGridDBColumn
          DataBinding.FieldName = 'Branch_Origin'
          Width = 82
        end
        object cxGrid1DBTableView2alamat1: TcxGridDBColumn
          DataBinding.FieldName = 'alamat1'
          Width = 165
        end
        object cxGrid1DBTableView2alamat2: TcxGridDBColumn
          DataBinding.FieldName = 'alamat2'
          Width = 136
        end
        object cxGrid1DBTableView2alamat3: TcxGridDBColumn
          DataBinding.FieldName = 'alamat3'
          Width = 105
        end
        object cxGrid1DBTableView2telp1: TcxGridDBColumn
          DataBinding.FieldName = 'telp1'
          Width = 46
        end
        object cxGrid1DBTableView2telp2: TcxGridDBColumn
          DataBinding.FieldName = 'telp2'
          Width = 46
        end
      end
  ...
  object DataSource1: TDataSource
    DataSet = _DataModuleMaster.MPlant
    Left = 26
    Top = 376
  end
