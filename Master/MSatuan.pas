...
type
  TMSatuanFrm = class(TForm)
    ...
    cxGrid1DBTableView2kode_satuan: TcxGridDBColumn;
    cxGrid1DBTableView2nama_satuan: TcxGridDBColumn;
...
procedure TMSatuanFrm.SetUpButtonOtorisasi;
begin
end;

procedure TMSatuanFrm.FormClose(Sender: TObject;
...
procedure TMSatuanFrm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMSatuanFrm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMSatuanFrm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMSatuanFrm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMSatuanFrm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMSatuanFrm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMSatuanFrm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
