...
type
  TMWilayah_Frm = class(TForm)
    ...
    cxGrid1DBTableView2wilayah: TcxGridDBColumn;
    cxGrid1DBTableView2nama_wilayah: TcxGridDBColumn;
...
procedure TMWilayah_Frm.SetUpButtonOtorisasi;
begin
end;

procedure TMWilayah_Frm.FormClose(Sender: TObject;
...
procedure TMWilayah_Frm.ExitBtnExecute(Sender: TObject);
begin
  Close;
end;

procedure TMWilayah_Frm.FormShow(Sender: TObject);
begin
  DataSource1.dataset.close;
  DataSource1.dataset.open;
end;

procedure TMWilayah_Frm.ExitClick(Sender: TObject);
begin
  Close;
end;

procedure TMWilayah_Frm.Exit_BTNClick(Sender: TObject);
begin
  Close;
end;

procedure TMWilayah_Frm.DBNavigatorButtonClick(Sender: TObject);
begin
  wwFilterDialog1.Execute;
end;

procedure TMWilayah_Frm.Export_BTNClick(Sender: TObject);
begin
...
procedure TMWilayah_Frm.wwDBNavigator1ButtonClick(Sender: TObject);
begin
