object Inf_SC_PO_RM_Frm: TInf_SC_PO_RM_Frm
  Left = 92
  Top = 78
  Width = 1360
  Height = 666
  Caption = 'Info PO - RM (SC)'
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object wwDBLookupCombo1: TwwDBLookupCombo
      ...
      Selected.Strings = (
        'kode_branch'#9'50'#9'kode_branch'#9'F'
        'nama_Branch'#9'150'#9'nama_Branch'#9'F')
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1vandor_name: TcxGridDBColumn
            DataBinding.FieldName = 'vandor_name'
            Width = 159
          end
          object cxGrid3DBTableView1material_sku: TcxGridDBColumn
            DataBinding.FieldName = 'material_sku'
            Width = 100
          end
          object cxGrid3DBTableView1material_description: TcxGridDBColumn
            DataBinding.FieldName = 'material_description'
            Width = 176
          end
          ...
          object cxGrid3DBTableView1Calc_Service_level: TcxGridDBColumn
            Caption = 'Service level (%)'
            DataBinding.FieldName = 'Calc_Service_level'
          end
          object cxGrid3DBTableView1outstanding_po: TcxGridDBColumn
            Caption = 'OutStanding PO'
            DataBinding.FieldName = 'outstanding_po'
          end
          object cxGrid3DBTableView1po_uom: TcxGridDBColumn
            DataBinding.FieldName = 'po_uom'
            Width = 43
          end
          ...
          object cxGrid3DBTableView1po_unit_price: TcxGridDBColumn
            DataBinding.FieldName = 'po_unit_price'
          end
          object cxGrid3DBTableView1ori_currency: TcxGridDBColumn
            DataBinding.FieldName = 'ori_currency'
            Width = 63
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'select r.* from ('
        ...
        'SELECT  a.plant_name, a.plant, a.po_number, a.po_date, a.vendor,' +
        ' a.vandor_name, a.material_sku, a.material_description, '
      '        a.po_qty, gr_qty,'
      '        a.outstanding_po,'
      '        a.po_uom,a.gr_date,  a.po_unit_price, '
      '        a.ori_currency, a.Requisitioner,a.Delivery_date,'
      '        '
      '        b.Group_Material_1 as Group_Material, b.JENIS'
      ''
      'FROM    SC_Po_rm AS a LEFT OUTER JOIN'
      
        '        mst_material_rm AS b ON CAST(a.material_sku AS int) = b.' +
        'Material_cd'
    ...
    object Daily_DBplant_name: TWideStringField
      DisplayLabel = 'Cabang Name'
      FieldName = 'plant_name'
      Size = 250
    end
    object Daily_DBplant: TWideStringField
      DisplayLabel = 'Cabang'
      FieldName = 'plant'
      Size = 50
    end
    object Daily_DBpo_number: TWideStringField
    ...
    object Daily_DBvendor: TWideStringField
      DisplayLabel = 'Vendor'
      FieldName = 'vendor'
      Size = 50
    end
    object Daily_DBvandor_name: TWideStringField
      DisplayLabel = 'Vendor Name'
      FieldName = 'vandor_name'
      Size = 250
    end
    object Daily_DBmaterial_sku: TWideStringField
      DisplayLabel = 'Material SKU'
      FieldName = 'material_sku'
      Size = 50
    end
    object Daily_DBmaterial_description: TWideStringField
      DisplayLabel = 'Material Description'
      FieldName = 'material_description'
      Size = 250
    end
    object Daily_DBpo_qty: TIntegerField
      DisplayLabel = 'PO Qty'
      FieldName = 'po_qty'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBgr_qty: TIntegerField
      DisplayLabel = 'GR Qty'
      FieldName = 'gr_qty'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBoutstanding_po: TIntegerField
      DisplayLabel = 'Outstanding PO'
      FieldName = 'outstanding_po'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBpo_uom: TWideStringField
      DisplayLabel = 'PO UOM'
      FieldName = 'po_uom'
      Size = 50
    end
    object Daily_DBgr_date: TDateField
      DisplayLabel = 'GR Date'
      FieldName = 'gr_date'
    end
    object Daily_DBpo_unit_price: TIntegerField
      DisplayLabel = 'PO Unit Price'
      FieldName = 'po_unit_price'
      DisplayFormat = '#,##0.;(#,##0.)'
    end
    object Daily_DBori_currency: TWideStringField
    ...
    object Daily_DBCalc_Service_level: TFloatField
      DisplayLabel = 'Service Level'
      FieldKind = fkCalculated
      FieldName = 'Calc_Service_level'
      DisplayFormat = '#,##0.;(#,##0.)'
      Calculated = True
    end
    object Daily_DBDelivery_date: TDateField
