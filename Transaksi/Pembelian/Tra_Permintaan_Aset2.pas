...
type
  TTra_Permintaan_Aset2_Frm = class(TClassTransaksi_NewFrm)
    ...
    ZMasterNAMA: TStringField;
    ZMasterALAMAT_1: TStringField;
    DBText18: TDBText;
    ...
    cxGrid2DBTableView1NAMA_ITEM: TcxGridDBColumn;
    ...
    ZdetilKODE_ITEM_1: TStringField;
    ZdetilNAMA_ITEM: TStringField;
...
var
  Tra_Permintaan_Aset2_Frm: TTra_Permintaan_Aset2_Frm;
...
procedure TTra_Permintaan_Aset2_Frm.SetUp;
begin
 try
...
procedure TTra_Permintaan_Aset2_Frm.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.OracleDataSet1DSStateChange(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.ApplicationEvents1Message(var Msg: tagMSG;
  var Handled: Boolean);
begin
  inherited;
  if Msg.message = WM_KEYDOWN then
    case Msg.wParam of
      VK_F1     : if (MainFrm.ActiveMDIChild.Name=Tra_Permintaan_Aset2_Frm.Name) then
                    zmaster.Insert;
      VK_F2     : if (MainFrm.ActiveMDIChild.Name=Tra_Permintaan_Aset2_Frm.Name) then
                    zmaster.Post;
      VK_F9     : if (MainFrm.ActiveMDIChild.Name=Tra_Permintaan_Aset2_Frm.Name) then
                    L1Click(L1);
      VK_F12    : begin
                    if (MainFrm.ActiveMDIChild.Name=Tra_Permintaan_Aset2_Frm.Name) then begin
                    if Panel2.Visible = true then begin
                      ...
                      if (MainFrm.ActiveMDIChild.Name=Tra_Permintaan_Aset2_Frm.Name) then
                      begin
                      try
                        ZMaster.post;
                      except
...
procedure TTra_Permintaan_Aset2_Frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  Action := caFree;
  Tra_Permintaan_Aset2_frm := nil;

end;

procedure TTra_Permintaan_Aset2_Frm.ZMasterNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.ZMasterAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Setup;
end;

procedure TTra_Permintaan_Aset2_Frm.ZMasterBeforePost(DataSet: TDataSet);
begin
  inherited;
  ZMasterNO_TRANSAKSI.asstring:=ZMasterKODE.asstring+'-'+ZMasterID_TRANSAKSI.asstring;
...
procedure TTra_Permintaan_Aset2_Frm.BitBtn1Click(Sender: TObject);
var i:integer;
begin
  inherited;
  ZBrowse.Close;
...
procedure TTra_Permintaan_Aset2_Frm.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.Export_BTNClick(Sender: TObject);
begin
  inherited;
  PopupMenuExport.Popup(mouse.CursorPos.X,mouse.CursorPos.Y);
end;

procedure TTra_Permintaan_Aset2_Frm.toExcelxls1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.toXMLxml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.toHTMLhtml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.toTekstxt1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.L1Click(Sender: TObject);
begin
  try
  inherited;
  except
...
procedure TTra_Permintaan_Aset2_Frm.Tambah_BTNClick(Sender: TObject);
begin
...
procedure TTra_Permintaan_Aset2_Frm.ZMasterBeforeDelete(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
  inherited;
...
procedure TTra_Permintaan_Aset2_Frm.wwNavButton2Click(Sender: TObject);
begin
  inherited;
  Zdetil.Prior;
end;

procedure TTra_Permintaan_Aset2_Frm.wwNavButton6Click(Sender: TObject);
begin
  inherited;
  Zdetil.Next;
end;

procedure TTra_Permintaan_Aset2_Frm.cxDBButtonEdit1PropertiesButtonClick(
  ...
  inherited;
   ...
   begin
     if Zmaster.state=dsbrowse then
      ...
      //ZMasterKODE_SALES.AsString:=_DataModuleMaster.MST_SUPPLIER_AKTIFsales_representatif_nik.AsString;
      Zmaster.Post;
   end;

end;

procedure TTra_Permintaan_Aset2_Frm.Cetak_BTNClick(Sender: TObject);
begin
 // inherited;
...
procedure TTra_Permintaan_Aset2_Frm.ZdetilNewRecord(DataSet: TDataSet);
begin
  inherited;
  ZdetilQTY.AsFloat:=1;
...
procedure TTra_Permintaan_Aset2_Frm.cxGridDBTableView1CellDblClick(
  Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TTra_Permintaan_Aset2_Frm.ZdetilAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Total_detil.close;
  Total_detil.Open;
...
procedure TTra_Permintaan_Aset2_Frm.ZdetilBeforePost(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
...
procedure TTra_Permintaan_Aset2_Frm.cxGridDBTableView1KeyDown(
...
procedure TTra_Permintaan_Aset2_Frm.SpeedButton1Click(Sender: TObject);
begin
  inherited;
                    if Panel2.Visible = true then begin
                      Panel2.Visible := false;
...
procedure TTra_Permintaan_Aset2_Frm.TabSheet2Show(Sender: TObject);
begin
  inherited;
  BitBtn1Click(Sender);
end;
