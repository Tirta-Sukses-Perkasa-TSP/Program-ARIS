...
type
  TTra_Nota_Penjualan_FOC_frm = class(TClassTransaksi_NewFrm)
    ...
    cxGridDBTableView1BRAND: TcxGridDBColumn;
...
var
  Tra_Nota_Penjualan_FOC_frm: TTra_Nota_Penjualan_FOC_frm;
...
procedure TTra_Nota_Penjualan_FOC_frm.SetUp;
begin
 try
...
procedure TTra_Nota_Penjualan_FOC_frm.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.OracleDataSet1DSStateChange(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.ApplicationEvents1Message(var Msg: tagMSG;
  var Handled: Boolean);
begin
  inherited;
  if Msg.message = WM_KEYDOWN then
    case Msg.wParam of
      VK_F1     : if (MainFrm.ActiveMDIChild.Name=Tra_Nota_Penjualan_FOC_frm.Name) then
                    zmaster.Insert;
      VK_F2     : if (MainFrm.ActiveMDIChild.Name=Tra_Nota_Penjualan_FOC_frm.Name) then
                    zmaster.Post;
      VK_F9     : if (MainFrm.ActiveMDIChild.Name=Tra_Nota_Penjualan_FOC_frm.Name) then
                    L1Click(L1);
      VK_F12    : begin
                    if (MainFrm.ActiveMDIChild.Name=Tra_Nota_Penjualan_FOC_frm.Name) then begin
                    if Panel2.Visible = true then begin
                      ...
                      if (MainFrm.ActiveMDIChild.Name=Tra_Nota_Penjualan_FOC_frm.Name) then
                      begin
                      try
                        ZMaster.post;
                      except
...
procedure TTra_Nota_Penjualan_FOC_frm.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  inherited;
  Action := caFree;
  Tra_Nota_Penjualan_FOC_frm := nil;

end;

procedure TTra_Nota_Penjualan_FOC_frm.ZMasterNewRecord(DataSet: TDataSet);
begin
  inherited;
  ...
  ZMasterKODE.asstring:='FOC-'+_DataModule.Vdepo;
...
procedure TTra_Nota_Penjualan_FOC_frm.ZMasterAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Setup;
end;

procedure TTra_Nota_Penjualan_FOC_frm.ZMasterBeforePost(DataSet: TDataSet);
begin
  inherited;
  ZMasterNO_TRANSAKSI.asstring:=ZMasterKODE.asstring+'-'+ZMasterID_TRANSAKSI.asstring;
...
procedure TTra_Nota_Penjualan_FOC_frm.BitBtn1Click(Sender: TObject);
var i:integer;
begin
  inherited;
  ZBrowse.Close;
...
procedure TTra_Nota_Penjualan_FOC_frm.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.Export_BTNClick(Sender: TObject);
begin
  inherited;
  PopupMenuExport.Popup(mouse.CursorPos.X,mouse.CursorPos.Y);
end;

procedure TTra_Nota_Penjualan_FOC_frm.toExcelxls1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.toXMLxml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.toHTMLhtml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.toTekstxt1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.L1Click(Sender: TObject);
begin
  try
  inherited;
  except
...
procedure TTra_Nota_Penjualan_FOC_frm.Tambah_BTNClick(Sender: TObject);
begin
...
procedure TTra_Nota_Penjualan_FOC_frm.ZMasterBeforeDelete(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
  inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.wwNavButton2Click(Sender: TObject);
begin
  inherited;
  Zdetil.Prior;
end;

procedure TTra_Nota_Penjualan_FOC_frm.wwNavButton6Click(Sender: TObject);
begin
  inherited;
  Zdetil.Next;
end;

procedure TTra_Nota_Penjualan_FOC_frm.cxDBButtonEdit1PropertiesButtonClick(
...
procedure TTra_Nota_Penjualan_FOC_frm.Cetak_BTNClick(Sender: TObject);
begin
 // inherited;
...
procedure TTra_Nota_Penjualan_FOC_frm.ZdetilNewRecord(DataSet: TDataSet);
begin
  inherited;
  ZdetilQTY.AsFloat:=1;
...
procedure TTra_Nota_Penjualan_FOC_frm.cxGridDBTableView1CellDblClick(
  Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TTra_Nota_Penjualan_FOC_frm.ZdetilAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Total_detil.close;
  Total_detil.Open;
...
procedure TTra_Nota_Penjualan_FOC_frm.ZdetilBeforePost(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
...
procedure TTra_Nota_Penjualan_FOC_frm.cxGridDBTableView1KeyDown(
...
procedure TTra_Nota_Penjualan_FOC_frm.SpeedButton1Click(Sender: TObject);
begin
  inherited;
                    if Panel2.Visible = true then begin
                      Panel2.Visible := false;
...
procedure TTra_Nota_Penjualan_FOC_frm.TabSheet2Show(Sender: TObject);
begin
  inherited;
  BitBtn1Click(Sender);
end;
