inherited Tra_Nota_Penjualan_frm: TTra_Nota_Penjualan_frm
  Left = 160
  Top = 86
  Width = 1365
  Height = 699
  Caption = 'Form Nota Penjualan'
  OldCreateOrder = True
  OnClose = FormClose
  PixelsPerInch = 96
  TextHeight = 13
          ...
          inherited Panel6: TPanel
            ...
            inherited Panel10: TPanel
              ...
              object AdvPanel13: TAdvPanel
                ...
                Caption.Indent = 5
                Caption.ShadeLight = 255
                Caption.Text = 'Tanggal Jatuh Tempo Bayar'
                Caption.TopIndent = 2
                Caption.Visible = True
                CollapsColor = clBtnFace
                CollapsDelay = 0
                ...
                object cxDBDateEdit5: TcxDBDateEdit
                  Left = 0
                  Top = 17
                  DataBinding.DataField = 'tgl_jatuh_tempo'
                  DataBinding.DataSource = Datasource1
                  Properties.ShowTime = False
                  TabOrder = 0
                  Visible = False
            ...
            object AdvPanel5: TAdvPanel
              ...
              object cxDBImageComboBox2: TcxDBImageComboBox
                ...
                Properties.Items = <
                  item
                    Description = 'JUAL LANGSUNG'
                    Value = 'JUAL LANGSUNG'
                  end
                  item
                    Description = 'NOTA JUAL'
                    Value = 'NOTA JUAL'
                  end>
                TabOrder = 0
                Width = 164
            ...
            object cxDBLookupComboBox2: TcxDBLookupComboBox
              ...
              DataBinding.DataSource = Datasource1
              Properties.DropDownAutoSize = True
              Properties.KeyFieldNames = 'KETERANGAN'
              Properties.ListColumns = <
                item
                  FieldName = 'DIVISI'
                end
              ...
              object cxGrid2DBTableView1: TcxGridDBTableView
                ...
                DataController.Summary.FooterSummaryItems = <
                  item
                    ...
                    Kind = skSum
                    FieldName = 'GROSS'
                    Column = cxGrid2DBTableView1GROSS
                    DisplayText = 'N: '
                  end>
                ...
                object cxGrid2DBTableView1qty_kirim: TcxGridDBColumn
                  DataBinding.FieldName = 'qty_kirim'
                  Options.Editing = False
                  Styles.Content = _DataModule.cxStyle9
                end
                object cxGrid2DBTableView1qty_kembali: TcxGridDBColumn
                  Caption = 'Qty Kembali'
        ...
        inherited cxGrid1DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Column = cxGrid1DBTableView1NO_TRANSAKSI
            end>
  ...
  object ZMaster: TUniQuery [11]
    ...
    SQLRefresh.Strings = (
        ...
        ' total_bayar, tgl_jatuh_tempo FROM NOTA_JUAL_M'
      'WHERE'
    ...
    object ZMasterLnama_Outlet: TStringField
      FieldKind = fkLookup
      FieldName = 'Lnama_Outlet'
      LookupDataSet = _DataModuleMaster.MST_OUTLET
    ...
    object ZMasterLnama_Sales: TStringField
      FieldKind = fkLookup
      FieldName = 'Lnama_Sales'
      LookupDataSet = _DataModuleMaster.Mkaryawan_all
      LookupKeyFields = 'NIK'
      LookupResultField = 'NAMA'
      KeyFields = 'KODE_SALES'
      Size = 250
      Lookup = True
    end
    object ZMasterLNAMA_DEPO: TStringField
      FieldKind = fkLookup
    ...
    object ZMasterLnama_Depo1: TStringField
      FieldKind = fkLookup
      FieldName = 'Lnama_Depo1'
      LookupDataSet = _DataModuleMaster.MList_Depo
      LookupKeyFields = 'DEPO'
      LookupResultField = 'Depo_1'
      KeyFields = 'DEPO'
      Size = 250
      Lookup = True
    end
  ...
  object Zdetil: TUniQuery [16]
    ...
    SQLRefresh.Strings = (
        ...
        '_transaksi_lama, qty_kembali FROM NOTA_JUAL_D'
      'WHERE'
  ...
  object Total_detil: TUniQuery
    ...
    Connection = _DataModule.UniErp_DEPO
    SQL.Strings = (
      'select sum(GROSS) as Total from NOTA_JUAL_D'
      'where no_transaksi=:no_transaksi')
    MasterSource = Datasource1
    MasterFields = 'NO_TRANSAKSI'
    DetailFields = 'NO_TRANSAKSI'
  ...
  object ppReport1: TppReport
    ...
    object ppPageStyle1: TppPageStyle
      ...
      object ppLabel8: TppLabel
        ...
        Border.Visible = False
        Caption = 
          'Copy Document :  Putih (Customer), Merah dan Kuning (Ficont), Hi' +
          'jau (Admin) dan Biru (Gudang)'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 10
