...
type
  TTra_BTB_frm = class(TClassTransaksi_NewFrm)
...
procedure TTra_BTB_frm.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.OracleDataSet1DSStateChange(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.ApplicationEvents1Message(var Msg: tagMSG;
  var Handled: Boolean);
begin
  inherited;
...
procedure TTra_BTB_frm.FormClose(Sender: TObject;
...
procedure TTra_BTB_frm.ZMasterNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TTra_BTB_frm.ZMasterAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Setup;
end;

procedure TTra_BTB_frm.ZMasterBeforePost(DataSet: TDataSet);
begin
  inherited;
  ZMasterNO_TRANSAKSI.asstring:=ZMasterKODE.asstring+'-'+ZMasterID_TRANSAKSI.asstring;
...
procedure TTra_BTB_frm.BitBtn1Click(Sender: TObject);
var i:integer;
begin
  inherited;
  ZBrowse.Close;
...
procedure TTra_BTB_frm.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.Export_BTNClick(Sender: TObject);
begin
  inherited;
  PopupMenuExport.Popup(mouse.CursorPos.X,mouse.CursorPos.Y);
end;

procedure TTra_BTB_frm.toExcelxls1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.toXMLxml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.toHTMLhtml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.toTekstxt1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.L1Click(Sender: TObject);
begin
...
procedure TTra_BTB_frm.Tambah_BTNClick(Sender: TObject);
begin
  ZMaster.ReadOnly:=false;
...
procedure TTra_BTB_frm.ZMasterBeforeDelete(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
  inherited;
...
procedure TTra_BTB_frm.ZdetilAfterPost(DataSet: TDataSet);
begin
  inherited;
  ZDetil.Refresh;
  //zDETIL.last;
...
procedure TTra_BTB_frm.wwNavButton2Click(Sender: TObject);
begin
  inherited;
  Zdetil.Prior;
end;

procedure TTra_BTB_frm.wwNavButton6Click(Sender: TObject);
begin
  inherited;
  Zdetil.Next;
end;

procedure TTra_BTB_frm.BitBtn3Click(Sender: TObject);
begin
  inherited;
  Browse_Permintaan.CLOSE;           
...
procedure TTra_BTB_frm.BitBtn2Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.cxGrid2DBTableView1NO_TRANSAKSI_NOTAPropertiesCloseUp(
  Sender: TObject);
begin
  inherited;
  ZDETIL.Post;
...
procedure TTra_BTB_frm.ZdetilBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TTra_BTB_frm.ZdetilNewRecord(DataSet: TDataSet);
begin
  inherited;
  ZdetilQTY.AsInteger:=1;
end;

procedure TTra_BTB_frm.Button4Click(Sender: TObject);
begin
  inherited;
  dmxPanel1.Visible:=False;
end;

procedure TTra_BTB_frm.Button3Click(Sender: TObject);
var
  I,vid_po   : integer;
begin
...
procedure TTra_BTB_frm.RadioButton3Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.RadioButton4Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_BTB_frm.cxGridDBTableView2CellDblClick(
  Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TTra_BTB_frm.cxGridDBTableView2KeyDown(Sender: TObject;
...
procedure TTra_BTB_frm.SpeedButton1Click(Sender: TObject);
begin
  inherited;
                    _DataModuleMaster.MProduct.close;
                    _DataModuleMaster.MProduct.open;
...
procedure TTra_BTB_frm.cxGrid2DBTableView1kode_outletPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
...
procedure TTra_BTB_frm.TabSheet2Show(Sender: TObject);
begin
  inherited;
  BitBtn1Click(Sender);
end;

procedure TTra_BTB_frm.TabSheet3Show(Sender: TObject);
begin
  inherited;
    Browse_Permintaan.CLOSE;           
  Browse_Permintaan.ParamByName('0').AsDateTime:=wwDBDateTimePicker2.Date;
