...
type
  TTra_Penerimaan_Aset2_Frm = class(TClassTransaksi_NewFrm)
    ...
    ZMasterkode_outlet: TStringField;
...
var
  Tra_Penerimaan_Aset2_Frm: TTra_Penerimaan_Aset2_Frm;
...
procedure TTra_Penerimaan_Aset2_Frm.SetUp;
begin
 try
...
procedure TTra_Penerimaan_Aset2_Frm.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.OracleDataSet1DSStateChange(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.ApplicationEvents1Message(var Msg: tagMSG;
  var Handled: Boolean);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.FormClose(Sender: TObject;
...
procedure TTra_Penerimaan_Aset2_Frm.ZMasterNewRecord(DataSet: TDataSet);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.ZMasterAfterDelete(DataSet: TDataSet);
begin
  inherited;
  Setup;
end;

procedure TTra_Penerimaan_Aset2_Frm.ZMasterBeforePost(DataSet: TDataSet);
begin
  inherited;
  ZMasterNO_TRANSAKSI.asstring:=ZMasterKODE.asstring+'-'+ZMasterID_TRANSAKSI.asstring;
...
procedure TTra_Penerimaan_Aset2_Frm.BitBtn1Click(Sender: TObject);
var i:integer;
begin
  inherited;
  ZBrowse.Close;
...
procedure TTra_Penerimaan_Aset2_Frm.cxGrid1DBTableView1DblClick(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.Export_BTNClick(Sender: TObject);
begin
  inherited;
  PopupMenuExport.Popup(mouse.CursorPos.X,mouse.CursorPos.Y);
end;

procedure TTra_Penerimaan_Aset2_Frm.toExcelxls1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.toXMLxml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.toHTMLhtml1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.toTekstxt1Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.L1Click(Sender: TObject);
begin
...
procedure TTra_Penerimaan_Aset2_Frm.Tambah_BTNClick(Sender: TObject);
begin
  ZMaster.ReadOnly:=false;
...
procedure TTra_Penerimaan_Aset2_Frm.ZMasterBeforeDelete(DataSet: TDataSet);
begin
  ZMaster.ReadOnly:=false;
  ZDetil.ReadOnly:=false;
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.ZdetilAfterPost(DataSet: TDataSet);
begin
  inherited;
  ZDetil.Refresh;
  //zDETIL.last;
...
procedure TTra_Penerimaan_Aset2_Frm.wwNavButton2Click(Sender: TObject);
begin
  inherited;
  Zdetil.Prior;
end;

procedure TTra_Penerimaan_Aset2_Frm.wwNavButton6Click(Sender: TObject);
begin
  inherited;
  Zdetil.Next;
end;

procedure TTra_Penerimaan_Aset2_Frm.BitBtn3Click(Sender: TObject);
begin
  inherited;
  Browse_Permintaan.CLOSE;           
...
procedure TTra_Penerimaan_Aset2_Frm.BitBtn2Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.cxGrid2DBTableView1NO_TRANSAKSI_NOTAPropertiesCloseUp(
  Sender: TObject);
begin
  inherited;
  ZDETIL.Post;
...
procedure TTra_Penerimaan_Aset2_Frm.ZdetilBeforePost(DataSet: TDataSet);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.ZdetilNewRecord(DataSet: TDataSet);
begin
  inherited;
  ZdetilQTY.AsInteger:=1;
end;

procedure TTra_Penerimaan_Aset2_Frm.Button4Click(Sender: TObject);
begin
  inherited;
  dmxPanel1.Visible:=False;
end;

procedure TTra_Penerimaan_Aset2_Frm.Button3Click(Sender: TObject);
var
  I,vid_po   : integer;
begin
...
procedure TTra_Penerimaan_Aset2_Frm.RadioButton3Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.RadioButton4Click(Sender: TObject);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.cxGridDBTableView2CellDblClick(
  Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton;
  AShift: TShiftState; var AHandled: Boolean);
begin
...
procedure TTra_Penerimaan_Aset2_Frm.cxGridDBTableView2KeyDown(Sender: TObject;
...
procedure TTra_Penerimaan_Aset2_Frm.SpeedButton1Click(Sender: TObject);
begin
  inherited;
                    _DataModuleMaster.MProduct.close;
                    _DataModuleMaster.MProduct.open;
...
procedure TTra_Penerimaan_Aset2_Frm.cxGrid2DBTableView1kode_outletPropertiesButtonClick(
  Sender: TObject; AButtonIndex: Integer);
begin
  inherited;
...
procedure TTra_Penerimaan_Aset2_Frm.TabSheet2Show(Sender: TObject);
begin
  inherited;
  BitBtn1Click(Sender);
end;

procedure TTra_Penerimaan_Aset2_Frm.TabSheet3Show(Sender: TObject);
begin
  inherited;
    Browse_Permintaan.CLOSE;           
  Browse_Permintaan.ParamByName('0').AsDateTime:=wwDBDateTimePicker2.Date;
