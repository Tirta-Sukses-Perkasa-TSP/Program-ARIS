object Comp_Stock_mars_vs_R3_FRM: TComp_Stock_mars_vs_R3_FRM
  Left = 237
  Top = 127
  Width = 798
  Height = 558
  Caption = 'Comp_Stock_mars_vs_R3_FRM'
  Color = clBtnFace
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          DataController.Summary.FooterSummaryItems = <
            ...
            item
              ...
              Kind = skSum
              FieldName = 'R3_qty'
              Column = cxGrid3DBTableView1R3_qty
            end
            item
              Format = '#,##0.;(#,##0.)'
              Kind = skSum
            ...
            item
              ...
              Column = cxGrid3DBTableView1MRS_kode_branch
            end
            item
              Format = '#,##0.00;(#,##0.00)'
              Kind = skSum
          ...
          object cxGrid3DBTableView1R3_DOCNO: TcxGridDBColumn
            DataBinding.FieldName = 'R3_DOCNO'
            Styles.Content = _DataModule.cxStyle6
            Width = 64
          end
          object cxGrid3DBTableView1R3_TRANSTYPE: TcxGridDBColumn
            DataBinding.FieldName = 'R3_TRANSTYPE'
            Styles.Content = _DataModule.cxStyle6
            Width = 90
          end
          object cxGrid3DBTableView1R3_qty: TcxGridDBColumn
            DataBinding.FieldName = 'R3_qty'
            Styles.Content = _DataModule.cxStyle6
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      'use mars'
      'select *'
      ' , case  WHEN abs(selisih_mrs_sapr3) <> 0 THEN 1 '
      '         ELSE 0 end as Flag_Selisih'
      '  from    ('
      'SELECT a.MRS_kode_branch as MRS_kode_branch'
      '      ,a.MRS_nama_Branch as MRS_nama_Branch'
      '      ,a.MRS_stockPOint_cd as MRS_SALESPOINTCD '
      '      ,a.MRS_STOCKPOINTNAME as MRS_STOCKPOINTNAME'
      '      ,a.MRS_tanggal as MRS_TGL'
      '      ,a.MRS_QTY as MRS_Qty'
      '      ,a.MRS_Document_Number '
      '      ,a.MRS_Transaction_Name'
      '      ,a.MRS_Type'
      '      ,a.MRS_Material_cd'
      '      ,a.MRS_Material_Nama'
      '      '
      '      ,d.SAP_SALESPOINTCD as R3_SALESPOINTCD'
      '      ,d.SAP_STOCKPOINTNAME as R3_STOCKPOINTNAME'
      '      ,d.SAP_PLANTCD as R3_Kode_Branch'
      '      ,d.SAP_POSTDATE as R3_Tax_date'
      '      ,d.SAP_QUANTITY1 as R3_qty'
      '      ,d.SAP_TRANSTYPE as R3_TRANSTYPE'
      '      ,d.SAP_DOCNO as R3_DOCNO'
      '      ,d.SAP_ITEMCD as R3_ITEMCD'
      '      ,d.SAP_Material_Nama as R3_Material_Nama'
      
        '      ,abs(isnull(a.MRS_QTY,0))-isnull(d.SAP_QUANTITY1,0) as sel' +
        'isih_mrs_sapr3'
      '    FROM MARS.dbo.VMrs_Stock a  Full  join'
      '       mars.dbo.VYB25A D ON d.SAP_PLANTCD=a.MRS_kode_branch'
      '       and D.SAP_SALESPOINTCD=a.MRS_stockPOint_cd'
      '       and d.SAP_TRANSTYPE=a.MRS_Type'
      '       and d.SAP_DOCNO=a.MRS_Document_Number'
      '       and d.SAP_ITEMCD=a.MRS_Material_cd'
      '       where isnull(a.MRS_tanggal,d.SAP_POSTDATE)>=:0'
      '         and isnull(a.MRS_tanggal,d.SAP_POSTDATE)<=:1'
      ' ) t')
    Left = 347
    Top = 166
    ParamData = <
    ...
    object Daily_DBR3_qty: TFloatField
      FieldName = 'R3_qty'
      ReadOnly = True
    end
    object Daily_DBR3_DOCNO: TStringField
      FieldName = 'R3_DOCNO'
      ReadOnly = True
      Size = 50
    end
    ...
    object Daily_DBR3_TRANSTYPE: TStringField
      FieldName = 'R3_TRANSTYPE'
      ReadOnly = True
      Size = 50
    end
    object Daily_DBR3_ITEMCD: TIntegerField
      FieldName = 'R3_ITEMCD'
      ReadOnly = True
    end
