...
type
  TComp_Stock_mars_vs_R3_FRM = class(TForm)
    Panel1: TPanel;
    Label3: TLabel;
    BitBtn1: TBitBtn;
    BitBtn2: TBitBtn;
    ...
    Daily_DBR3_qty: TFloatField;
    Daily_DBR3_DOCNO: TStringField;
    ...
    cxGrid3DBTableView1R3_qty: TcxGridDBColumn;
    cxGrid3DBTableView1R3_DOCNO: TcxGridDBColumn;
    cxGrid3DBTableView1selisih_mrs_sapr3: TcxGridDBColumn;
    cxGrid3DBTableView1Flag_Selisih: TcxGridDBColumn;
    Daily_DBR3_TRANSTYPE: TStringField;
    cxGrid3DBTableView1R3_TRANSTYPE: TcxGridDBColumn;
    Daily_DBR3_ITEMCD: TIntegerField;
...
var
  Comp_Stock_mars_vs_R3_FRM: TComp_Stock_mars_vs_R3_FRM;
implementation
...
procedure TComp_Stock_mars_vs_R3_FRM.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Action := caFree;
  Comp_Stock_mars_vs_R3_FRM := nil;
end;

procedure TComp_Stock_mars_vs_R3_FRM.BitBtn1Click(Sender: TObject);
var AIndex: integer;
...
procedure TComp_Stock_mars_vs_R3_FRM.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TComp_Stock_mars_vs_R3_FRM.FormShow(Sender: TObject);
var i: Integer;
begin
...
procedure TComp_Stock_mars_vs_R3_FRM.Button1Click(Sender: TObject);
begin
  cxGrid3DBTableView1.ApplyBestFit;
end;

procedure TComp_Stock_mars_vs_R3_FRM.cxGrid3DBTableView1CustomDrawCell(
  Sender: TcxCustomGridTableView; ACanvas: TcxCanvas;
  AViewInfo: TcxGridTableDataCellViewInfo; var ADone: Boolean);
var
  val : String;
...
procedure TComp_Stock_mars_vs_R3_FRM.Button3Click(Sender: TObject);
begin
  cxGrid3DBTableView1.DataController.DataSource:=UniDataSource1;
end;

procedure TComp_Stock_mars_vs_R3_FRM.Grid1Click(Sender: TObject);
begin
...
procedure TComp_Stock_mars_vs_R3_FRM.DataRaw1Click(Sender: TObject);
begin
