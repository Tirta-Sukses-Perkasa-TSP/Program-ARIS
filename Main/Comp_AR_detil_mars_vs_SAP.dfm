object Comp_AR_detil_mars_vs_SAP_FRM: TComp_AR_detil_mars_vs_SAP_FRM
  Left = 166
  Top = 48
  Width = 1130
  Height = 610
  Caption = 'Comp_AR_detil_mars_vs_SAP_FRM'
  Color = clBtnFace
    ...
    object TabSheet2: TTabSheet
      ...
      object cxGrid3: TcxGrid
        ...
        object cxGrid3DBTableView1: TcxGridDBTableView
          ...
          object cxGrid3DBTableView1sap_kode_branch: TcxGridDBColumn
            DataBinding.FieldName = 'sap_kode_branch'
            Width = 91
          end
  ...
  object Daily_DB: TUniQuery
    ...
    SQL.Strings = (
      ...
      '  FROM [MARS].[dbo].[VAr_Mars_Rekap] a  Full  join'
        ...
        '  mars.dbo.VAR_SAp_R3_Rekap D ON D.sap_SALESPOINTCD=a.mrs_SALESP' +
        'OINTCD'
      '          and a.mrs_kode_branch=d.sap_kode_branch'
      '           '
      '  where isnull(a.mrs_TGL,d.sap_TGL)=:0'
      ' ) T')
    Active = True
    Left = 347
    Top = 166
    ...
    object Daily_DBsap_kode_branch: TStringField
      FieldName = 'sap_kode_branch'
      ReadOnly = True
      Size = 250
    end
